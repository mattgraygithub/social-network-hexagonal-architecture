...
public class SocialNetworkWebAppAcceptanceTest {
    ...
    private void makePostRequestFor(String userName, String commandString, String port, String path, LocalDateTime timeOfConnection) throws IOException {
    ...
    private String makeGetRequestFor(String userName, String port, String path, LocalDateTime timeOfConnection) throws IOException {
    ...
    private HttpURLConnection setUpHttpURLConnectionFor(String userName, String requestMethod, String port, String path, LocalDateTime timeOfConnection) throws IOException {
        setUpClockStubWith(timeOfConnection);
        URL url = new URL(HOST + port + path + userName);
